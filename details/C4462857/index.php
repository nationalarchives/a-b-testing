...
<head>
    <meta charset="utf-8">
    <title>Name   Minall, Alfred Hamblyn     Date of Birth:   25 July 1899 | The National Archives</title>
    ...
    <meta name="description" content="The official archive of the UK government. Our vision is to lead and transform information management, guarantee the survival of today's information for tomorrow and bring history to life for everyone." />
    ...
    <meta name="DC.description" content="The National Archives is the UK government's official archive. Our main duties are to preserve Government records and to set standards in information management and re-use." />
    <meta name="eGMS.subject.category" scheme="GCL" content="Libraries and archives" />


    <meta name="DCSext.docref" content="AIR 76/350/126">
    <meta name="DCSext.prodpgtype" content="Unavailable">
    <meta name="WT.pn_sku" content="AIR 76/350/126">
    ...
    <meta name="DCSext.feature" content="TTTWidget">
    <meta name="WT.cg_n" content="View TNA download record description">
    <link href="http://discovery.nationalarchives.gov.uk/Content/compiled-css/main.min.17.07.2017.css" type="text/css" rel="stylesheet" />
    ...
    <script src="http://discovery.nationalarchives.gov.uk/Scripts/modernizr.min.js"></script>
    ...
    <link href="http://discovery.nationalarchives.gov.uk/Content/images/favicon.ico" type="image/x-icon" rel="Shortcut Icon" />
...
<?php include "../optimize-snippet.php"; ?>
        ...
        <div id="holds-logo-and-search" class="row">
            <div id="logo-holder" class="col starts-at-full ends-at-half clr">
                <a title="Go to The National Archives homepage" href="http://www.nationalarchives.gov.uk">
                    <img src="http://discovery.nationalarchives.gov.uk/Content/Images/logo-white.png" alt="The National Archives" title="The National Archives" />
                </a>
                <form id="mobile-global-search" method="get" action="http://nationalarchives.gov.uk/search/results">
                    <div id="mobile-search-outer-wrapper">
                        <div id="mobile-search-wrapper">
                            <input type="text" aria-required="true" required name="_q" placeholder="Search our website..." id="mobile-search-field" autocomplete="off">
                            <input type="submit" id="mobileSearchSubmit" value="" />
                        </div>
                        <div id="change-destination">
                            <span><input type="radio" data-fieldname="_q" data-placeholder="Search our website..." data-target="http://nationalarchives.gov.uk/search/results" id="websiteSearch" name="searchDestination" class="mobileSearchDestinationOption" checked=""><label for="websiteSearch">Search our website</label></span>
                            <span><input type="radio" data-fieldname="_q" data-placeholder="Search our records..." data-target="/results/r" id="catalogueSearch" name="searchDestination" class="mobileSearchDestinationOption"><label for="catalogueSearch">Search our records</label></span>
                        </div>
                    </div>
                </form>
            </div>
            <div class="col starts-at-full ends-at-half clr">
                <div id="search-field-wrapper" role="search">
                    <form id="globalSearch" method="get" action="http://nationalarchives.gov.uk/search/results">
                        <span id="scope-selector" class="interactive-element">&nbsp;</span>
                        <input type="text" aria-required="true" required="" name="_q" id="tnaSearch" placeholder="Search our website..." class="search-field" autocomplete="off">
                        <input type="submit" value="" id="search-button" class="search-button">
                    </form>
                    <ul id="search-options">
                        <li><a aria-label="Change form destination to search the website" role="button" data-fieldname="_q" data-placeholder="Search our website..." data-target="http://nationalarchives.gov.uk/search/results" class="formDestinationChanger" href="#">Search our website</a></li>
                        <li><a aria-label="Change form destination to search the catalogue" role="button" data-fieldname="_q" data-placeholder="Search our records..." data-target="/results/r" class="formDestinationChanger" href="#">Search our records</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <nav class="col mega-menu-group clr">
                <div>
                    ...
                    <ul>
                        ...
                        <li><a onclick="dcsMultiTrack('DCS.dcsuri','/menu/Contact us ','WT.ti','Menu - Contact us ');" href="http://www.nationalarchives.gov.uk/contact/">Contact us</a></li>
    ...
    <div id="account-controls-wrapper">
        <div id="account-controls" class="container">
            <ul>
                ...
                <li id="miniBasket">
        <span class="noItems">
            <img src="http://discovery.nationalarchives.gov.uk/Content/Images/basket.png" id="basketIcon" alt="Basket icon" />
            No items
        </span>
                </li>
...
<main id="page_wrap" class="container" role="main">
        ...
        <div class="col starts-at-full ends-at-half clr">
            <nav id="breadcrumb">
                ...
                <ul>
                    ...
                    <li><a class="breadcrumbs" href="http://discovery.nationalarchives.gov.uk/results/r?_q=alfred+minall">Your search results</a>AIR 76/350/126</li>
                </ul>
            </nav>
        </div>
        <div class="col starts-at-full ends-at-half clr">
            ...
            <nav id="page-controls">
                ...
                <ul>
                    ...
                    <li>
                        <a class="printThisPage" onclick="dcsMultiTrack('DCS.dcsuri','/Product Details Page/Print','WT.ti','Search Results: Print','WT.cg_n','Utilities','WT.dl','0', 'WT.oss','', 'WT.oss_r','', 'WT.osspageno','', 'WT.ossview','', 'DCSext.searchtype','','WT.pn_sku','','WT.pn_sc','',' WT.pn_gr','',' WT.pn_fa','',' WT.si_n','',' WT.si_p','', 'WT.tx_e','');"
                           href="javascript:window.print()" title="print">Print</a>
                    </li>
                    <li>
                        <a href="http://www.nationalarchives.gov.uk/help-with-your-research/discovery-help" target="_blank" onclick="dcsMultiTrack('DCS.dcsuri','/SearchHelp', 'WT.ti', 'Search Help', 'WT.cg_n', 'Search Help', 'WT.dl','0');" id="helpLink">
                            Discovery help
                        </a>
                    </li>
    ...
    <section class="row">
        <div class="col starts-at-full ends-at-two-thirds clr holding-box">
            <div class="breather">
                <h1 class="inline">Name   Minall, Alfred Hamblyn     Date of Birth:   25 July 1899</h1>
                ...
                <div class="order-option-wrapper">
                    ...
                    <section class="order-option-main breather">
                        ...
                        <div class="order-option-description">
                            ...
                            <p>Download size approximately 1 MB. Download format PDF </p>

                        </div>
                        <div class="order-buttons">


                            <a href="/details/download?iaid=D8206854&reference=AIR%2076%2F350%2F126&token=636444546294929933&edocId=8649163" class="discoveryPrimaryCallToActionLink" data-webtrends-call="downloadFullRecord">Download now</a>
                    ...
                    <section class="supplemental-content breather">
                        ...
                        <section>
                            ...
                            <ul>
                                <li><a href='http://search.findmypast.co.uk/search-world-records/british-royal-air-force-officers-service-records-1912-1920'target='_blank'data -webtrends-call='onsiteInfo' >Findmypast</a></li>
                            </ul>
                ...
                </div>    <!-- if staff, display delivery options presented to other users -->
                ...
                <table class="asset-details">
                    <caption>Details of AIR 76/350/126</caption>
                    <tbody>
                    <tr>
                        ...
                        <td id="annotationcontentdescription">
                            <table>
                                <tr class="medalRow">
                                    ...
                                    <td class="medalplain" width="20%">Minall, Alfred Hamblyn</td>
                                </tr>
                                <tr class="medalRow">
                                    <td class="medalheader"> Date of Birth: </td>
                                    <td class="medalplain">25 July 1899</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <div id="hierarchy">
                    ...
                    <a class="browseByReference" href="/browse/r/r/D8206854">Browse by Reference</a>        <ul>
                        <a href="/browse">All departments</a>            <li><a href="/browse/r/h/C8">AIR - Records created or inherited by the Air Ministry, the Royal Air Force, and related bodies</a></li><li><a href="/browse/r/h/C955">Division within AIR - Records of the Department of the Master General of Personnel and the Air Member for Personnel</a></li><li><a href="/browse/r/h/C2130">AIR 76 - Air Ministry: Department of the Master-General of Personnel: Officers&#39; Service Records</a></li><li><a href="/browse/r/h/C510468">AIR 76/350 - Milman, Hugh - Mitchell, Basil</a></li><li><a href="/browse/r/h/D8206854">AIR 76/350/126 - Name     Minall, Alfred Hamblyn          Date of Birth:     25 July 1899</a></li>
                    </ul>
                </div>
                ...
                <div id="traces-through-time-collection">
                    ...
                    <div class="ttt-item">
                        <div class="heading-container clr">
                            <h3><a class="internal" href="/details/r/C14838889">Minall, A H</a></h3>
                            <p>Service number(s): 176010</p>

                        </div>
                        <!-- end heading-container -->
                        <div class="content-container clr">
                            <ul>
                                <li>AIR 79/1585/176010</li>
                                <li><span class="internal"></span>Airman&#39;s service record</li>
                            </ul>
                            <div class="indicator">
                                <p><b>Strong</b> match</p>
                                <div class="indicator-outer-container">
                                    <div class="indicator-inner-container">
                                        <div class="confidence-bar" style="width: 76.46%">
                                        </div>
                                    </div>
                                    <!-- end indicator-inner-container -->
                                </div>
                                <!-- end indicator-outer-container -->
                            </div>
                            <!-- end indicator -->
                        </div>
        ...
        <div class="col starts-at-full ends-at-one-third clr holding-box">
                ...
                <div id="user-contributions">
                    ...
                    <div class="add-tag ">
                        <ul id="add-tag-list" style="display:none;">
                            <li>
                                <p>
                                    Enter the tag you would like to associate with this record and click &#39;Add tag&#39;. Please ensure the tag is appropriate for the record.
                                    <br />
                                    <a href="/tags/index/howtotag">Read tagging guidelines</a>
                                </p>



                                <!-- TODO: For the avoidance of misunderstandimg - It goes without saying that this style is only for temporary use during development!!!... -->
                                ...
                                <div class="tagForm">
                                    <form action="/Details/AddTag?iaid=D8206854" method="post">                        <label for="tagEntryText" class="entryLabel">Enter tag:</label>
                        ...
                        <ul id="sign-in-or-register" style="">
                            <li>
                                <p>
                                    You need to <a href="/sign-in">sign in</a> to tag records. If you dont have an account please <a href="/register?returnUrl=%2Fdetails%2Fr%2FD8206854">register</a>.<br/><a href="/tags/index/howtotag">Read tagging guidelines</a>
                                </p>
                            </li>
                        </ul>
            ...
            <form action="/details/r/D8206854/submitcorrection" id="suggest-a-correction-form" method="post">    <h2><span><span>Found an error?</span></span></h2>
                <div class="breather">
                ...
                <div class="breather suggestion-form-wrapper">
                    ...
                    <div class="form-field-group">
                        ...
                        <textarea cols="20" data-val="true" data-val-length="Maximum decription length is 1000 characters" data-val-length-max="1000" data-val-required="This field is required" id="whatIsTheError" name="Description" rows="2">
</textarea>
                    </div>
                    <div class="form-field-group">
                        ...
                        <textarea cols="20" data-val="true" data-val-length="Maximum decription length is 1000 characters" data-val-length-max="1000" data-val-required="This field is required" id="whatIsTheRecommendation" name="Recommendation" rows="2">
</textarea>
                    </div>
                    <div class="form-field-group">
                        ...
                        <textarea cols="20" id="referenceDetails" name="ReferenceDetails" rows="2">
</textarea>
                    </div>
                </div>
                <div class="breather suggestion-form-wrapper">
                ...
                <input id="Hash" name="Hash" type="hidden" value="" /><input id="DocReference" name="DocReference" type="hidden" value="AIR 76/350/126" /><input id="ID" name="ID" type="hidden" value="D8206854" /></form>
        </div>
    </section></main>
    ...
    <div class="newsletter-template">
        ...
        <div class="news-form">
            <form name="signup" id="signup" action="https://r1-t.trackedlink.net/signup.ashx" method="post" role="form">
                ...
                <input type="hidden" name="cd_SOURCE" value="discovery">
                ...
                <div class="footer-left">
                    ...
                    <div class="follow-us">
                        ...
                        <a href="https://www.flickr.com/photos/nationalarchives" title="Follow us on Flickr"
                           target="_blank">
                            <img src="https://www.nationalarchives.gov.uk/wp-content/themes/tna-base/img/social/flickr.png" alt="Flickr logo">
                        </a>
                        ...
                        <a href="http://www.nationalarchives.gov.uk/rss/" title="Follow us via RSS">
                            <img src="https://www.nationalarchives.gov.uk/wp-content/themes/tna-base/img/social/rss.png" alt="RSS logo">
                        </a>
                    </div>
                </div>
                <div class="footer-left">
...
<!-- end footer-wrapper -->
<div id="version">
    Version 5.6 - September 2017 - OnSitePublic
</div>
...
<script src="http://www.nationalarchives.gov.uk/script/webtrends.js"></script>
...
<![endif]-->
<!--[if gte IE 9]><!-->
<script src="http://discovery.nationalarchives.gov.uk/Scripts/jquery-2.0.3.min.js"></script>
<!--<![endif]-->
<!-- TNA scripts -->
<script src="http://discovery.nationalarchives.gov.uk/Scripts/Build/discovery.17.07.2017.min.js"></script>


<script src="http://discovery.nationalarchives.gov.uk/Scripts/jquery.validate.min.js"></script>
<script src="http://discovery.nationalarchives.gov.uk/Scripts/jquery.validate.unobtrusive.min.js"></script>
<script src="http://discovery.nationalarchives.gov.uk/Scripts/Build/details.min.js"></script>
<script src="http://discovery.nationalarchives.gov.uk/Scripts/WebTrends/webtrends-details-page.js"></script>

<!--[if lt IE 9]>
<script src="http://discovery.nationalarchives.gov.uk/Scripts/json3.min.js"></script>
<script src="http://discovery.nationalarchives.gov.uk/Scripts/es5-shim.min.js"></script>
<![endif]-->
<script src="http://discovery.nationalarchives.gov.uk/Scripts/imageviewer/app/lib/angular/angular.min.js"></script>
<script src="http://discovery.nationalarchives.gov.uk/Scripts/imageviewer/app/lib/hammerJS/hammer.min.js"></script>
<script src="http://discovery.nationalarchives.gov.uk/Scripts/imageviewer/dist/scripts/image-viewer.min.js"></script>
<script>
...
<script src="http://discovery.nationalarchives.gov.uk/Scripts/WebTrends/webtrends-traces-through-time.js"></script>


<script src="http://nationalarchives.gov.uk/scripts/footer-img.js" defer></script>
